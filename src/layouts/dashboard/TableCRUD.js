...
import CreateObservationDialog from "./dialogs/createObservationDialog";
import UpdateObservationDialog from "./dialogs/updateObservationDialog";
import { removeTaskGroup } from "src/services/ObservationService";
import { removeTaskUser } from "../../services/UserService";

const TableCRUD = ({ id, type, tasks, reload }) => {
